...
namespace MyWebAPI.Attributes
{
    public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        public BasicAuthenticationHandler(
            ...
            IBasicAuthService basicAuthService) // User repository to handle user data
            : base(options, logger, encoder) // Pass options, logger, and encoder to the base class
        {
            _basicAuthService = basicAuthService; // Initialize user repository with dependency injection
        }
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            try
            {
                ...
                user = await _basicAuthService.ValidateUser(username, password);
            }
